    ...
    <section id="facilities" className="py-20 bg-slate-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
          <span className="inline-block px-3.5 py-1.5 rounded-full text-xs font-bold bg-csps-maroon/10 text-csps-maroon uppercase tracking-wide">
            {dict.facilities.tag}
          </span>
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${
                  isActive
                    ? "bg-csps-navy text-white shadow-md"
        ...
        {/* 20 Facilities Interactive Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {filteredList.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-sm hover:shadow-xl hover:border-csps-maroon/40 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between group"
              >
        ...
        <div className="mt-16 rounded-3xl bg-white p-6 lg:p-8 border border-slate-200 shadow-xl">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="relative rounded-2xl overflow-hidden aspect-[4/3] group">
              ...
              <span className="absolute bottom-2 start-2 text-[11px] font-bold text-white bg-slate-900/60 px-2 py-0.5 rounded backdrop-blur-sm">
